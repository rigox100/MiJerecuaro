...
<head>
    ...
    <!-- Author Meta -->
    <meta name="author" content="MiJerecuaro">
    <!-- Meta Keyword -->
    <meta name="keywords" content="MiJerecuaro, Todo lo que buscas, encuentras, negocios, Acámbaro">
    <!-- Meta Description -->
    <meta name="description" content="Entra y descubre lugares en Jerécuaro de una manera rápida y sencilla. En miacambaro.mx ¡Todo lo que buscas lo encuentras y lo que no también! Esta aplicación ha sido creada con el objetivo de apoyar a los negocios, profesionistas y personas que tienen algún oficio a darse a conocer por medio de la publicación de sus productos y servicios.">
    <!-- Page Title -->
    <title> Inicio | MiJerécuaro</title>
    <!--Icon-->
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-12">
                    <div class="slider-title_box">
                        <div class="row">
                            <div class="col-md-12">
                            <!-- <img src="images/login.png" width="170" height="170"  class="chidas" alt=""> -->
                                <div class="slider-content_wrap contenedor-texto">
                               
                                    <h1 class="tam" style="font-size: calc(1em + 1vw);">Buscador Comercial Jerécuaro </h1>
                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            <div hidden id="errores"></div>
                                ...
                                <a href="registro.php">
                                    <p style="font-size: 20px; color: #fff; text-shadow: black 0.1em 0.1em 0.2em;   margin-top: 16px;">Registrate en | Mi Jerécuaro</p>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="copyright">
                        ...
                        <p>Copyright &copy; 2020. Todos los derechos reservados | mijerecuaro.mx</p>
                        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        <ul>
