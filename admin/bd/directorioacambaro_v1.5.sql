...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-10-2020 a las 17:55:37
...
CREATE TABLE `solicitudes` (
  ...
  `cp` int(11) NOT NULL,
  `municipio` enum('Acámbaro','Coroneo','Jerécuero','Salvatierra') NOT NULL,
...
INSERT INTO `solicitudes` (`idSolicitud`, `idUsuario`, `nombre_negocio`, `rfc`, `tel`, `calle`, `colonia`, `cp`, `municipio`, `estado`, `estatus_solicitud`, `fecha_solicitud`, `descripcion`, `observaciones`) VALUES
(2, 51, 'Pepito Company', 'PEPECOM868686', '417111111', 'Hidalgo # 222', 'Centro', 38600, 'Acámbaro', 'Guanajuato', 'Rechazada', '2020-10-03', 'Mi negocio', 'Revise su RFC'),
(12, 52, 'Panaderia la conchita', 'CONCHITA12121', '4171111111', 'Guadalupe Victoria # 111', 'Centro', 38600, 'Acámbaro', 'Guanajuato', 'En proceso', '2020-10-05', 'asasas', ''),
(13, 53, 'Restaurante \"El pollo\"', 'POLLO12343434', '41711111', '1 de Mayo 221', 'Centro', 38600, 'Acámbaro', 'Guanajuato', 'En proceso', '2020-10-06', 'Ricos pollos a la leña', '');
